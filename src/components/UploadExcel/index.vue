<template>
  <div class="upload-excel-container">
    ...
    >
      <svg-icon iconName="upload" className="uploac-icon"></svg-icon>
...
// input 文件上传业务
const tagUpladInput = ref(null)
// 点击了文件上传按钮
const handleUpload = () => {
  // 触发input 的点击事件
  tagUpladInput.value.click()
}
// 选择了文件触发的事件
...
// 执行上传 beforUpload beforUpload 才执行读取操作
